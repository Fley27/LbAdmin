...
class NavContent extends Component {
    ...
    render() {
       /*  if(this.props.auth.user.access == 'coach'){ */
       ...
       /*  } */
        /* else if(this.props.auth.user.access == 'coach'){
            
            console.log("Hey this is coach navitems speaking");
            
            const navItems = this.props.navigationcoach.map(item => {
                switch (item.type) {
                    case 'group':
                        return <NavGroup layout={this.props.layout} key={item.id} group={item}/>;
                    default:

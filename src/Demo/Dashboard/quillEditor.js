...
class QuillEditor extends React.Component {
  ...
  insertImage = (e) => {
    ...
    if (
      ...
      axios
        .post("https://mighty-ridge-28744.herokuapp.com/api/blog/fileupload", formData, config)
        .then((response) => {
  ...
  insertVideo = (e) => {
    ...
    if (
      ...
      axios.post("api/users/fileupload", formData, config).then((response) => {
        if (response.data.success) {
          ...
          quill.insertEmbed(position, "video", {
            src:
              "https://mighty-ridge-28744.herokuapp.com/" + response.data.url,
